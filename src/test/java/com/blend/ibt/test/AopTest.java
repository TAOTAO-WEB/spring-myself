...
import com.blend.ibt.bean.UserServiceBeforeAdvice;
import com.blend.ibt.bean.UserServiceInterceptor;
import com.blend.ibt.springframework.aop.AdvisedSupport;
import com.blend.ibt.springframework.aop.ClassFilter;
import com.blend.ibt.springframework.aop.MethodMatcher;
...
import com.blend.ibt.springframework.aop.framework.ReflectiveMethodInvocation;
import com.blend.ibt.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
public class AopTest {
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* com.blend.ibt.bean.IUserService.*(..))");
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* com.blend.ibt.bean.IUserService.*(..))");
